...
namespace AgencyOS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260909072201_AiResultClassification")]
    partial class AiResultClassification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgencyOS.Domain.Ai.AgentRun", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("ExecutionDevice")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("execution_device");
                    ...
                    b.Property<int>("ModelInvocationCount")
                        .HasColumnType("integer")
                        .HasColumnName("model_invocation_count");
                    ...
                    b.Property<int>("ResultSensitivity")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1)
            ...
            modelBuilder.Entity("AgencyOS.Domain.Ai.AgentRunStep", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("OrganizationId", "AgentRunId");

                    b.ToTable("ai_run_steps", (string)null);
                });

            modelBuilder.Entity("AgencyOS.Domain.Ai.AiApproval", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("ToolRequestId")
                        .IsUnique()
                        .HasDatabaseName("ux_ai_approvals_request");

                    b.HasIndex("OrganizationId", "RequestedOf", "Decision")
                        .HasDatabaseName("ix_ai_approvals_pending")
                        .HasFilter("decision = 1");

                    b.ToTable("ai_approvals", (string)null);
                });

            modelBuilder.Entity("AgencyOS.Domain.Ai.AiContextLease", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("ContextFingerprint")
                        ...
                        .HasColumnName("context_fingerprint");
                    ...
                    b.HasIndex("OrganizationId", "AgentRunId", "State")
                        .HasDatabaseName("ix_ai_context_leases_run");

                    b.ToTable("ai_context_leases", (string)null);
                });

            modelBuilder.Entity("AgencyOS.Domain.Ai.AiProviderPolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<bool>("AllowsCanonicalWriteProposals")
                        .HasColumnType("boolean")
                        .HasColumnName("allows_write_proposals");

                    b.Property<bool>("IsEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("is_enabled");

                    b.Property<int>("MaximumSensitivity")
                        .HasColumnType("integer")
                        .HasColumnName("maximum_sensitivity");
                    ...
                    b.ToTable("ai_provider_policies", (string)null);
                });

            modelBuilder.Entity("AgencyOS.Domain.Ai.AiToolRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("AgentRunId", "Fingerprint")
                        .IsUnique()
                    ...
                    b.ToTable("ai_tool_requests", (string)null);
                });
            ...
            modelBuilder.Entity("AgencyOS.Domain.Ai.AgentRunStep", b =>
                {
                    b.HasOne("AgencyOS.Domain.Ai.AgentRun", null)
                        .WithMany("Steps")
                        .HasForeignKey("OrganizationId", "AgentRunId")
